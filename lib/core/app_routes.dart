  ...
  static Route<dynamic> getRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutesManager.resetPasswordDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const ResetPasswordDone());
      ...
      case RoutesManager.addNewStudentDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const AddNewStudentDone());
      case RoutesManager.removeOrderJoiningDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const RemoveOrderJoiningDone());
      case RoutesManager.groupStatistics:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const GroupStatistics());
      ...
      case RoutesManager.createGroupDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const CreateGroupDone());
      case RoutesManager.studentsProfile:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const StudentProfile());
      ...
      case RoutesManager.addNewClass:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const AddNewClass());
      case RoutesManager.addNewClassByQR:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const AddNewClassByQR());
      case RoutesManager.addNewClassDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const AddNewClassDone());
      ...
      case RoutesManager.yourOpinion:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const YourOpinion());
      case RoutesManager.addOpinionDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const AddOpinionDone());
      case RoutesManager.profileEditing:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const ProfileEditing());
      case RoutesManager.resetEmail:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const ResetEmail());
      case RoutesManager.resetEmailGetCode:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const ResetEmailGetCode());
      case RoutesManager.setEmailNow:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const SetEmailNow());
      case RoutesManager.resetEmailDone:
        return PageRouteBuilder(
            pageBuilder: (_, __, ___) => const ResetEmailDone());
