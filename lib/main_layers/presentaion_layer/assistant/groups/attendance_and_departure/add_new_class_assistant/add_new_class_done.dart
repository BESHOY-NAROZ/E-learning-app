...
class AddNewClassDoneAssistant extends StatelessWidget {
  const AddNewClassDoneAssistant({Key? key}) : super(key: key);
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const MainTextBlue(
              myText: AppStrings.kAddClassDoneGroups,
            ),
            SizedBox(height: AppDimensions.getDimensions(requiredHeight: 18)),
            Text(
              AppStrings.kAddClassHintGroups,
            ...
            MainButtonRed(
              buttonName: AppStrings.kAddClassButtonGroups,
              onPressed: () {
