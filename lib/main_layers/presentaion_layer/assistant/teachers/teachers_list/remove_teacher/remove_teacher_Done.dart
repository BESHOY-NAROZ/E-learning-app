...
class RemoveTeacherDone extends StatelessWidget {
  const RemoveTeacherDone({Key? key}) : super(key: key);
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const MainTextBlue(
              myText: AppStrings.kMainDeleteTeacherTeachers,
            ),
            SizedBox(height: AppDimensions.getDimensions(requiredHeight: 18)),

            const Text(
              AppStrings.kHintDeleteTeacherTeachers,
