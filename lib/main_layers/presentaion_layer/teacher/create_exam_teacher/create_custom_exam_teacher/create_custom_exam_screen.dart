...
import 'package:assiut_project/main_layers/presentaion_layer/teacher/create_exam_teacher/create_custom_exam_teacher/create_custom_exam_bottom_sheet.dart';
import 'package:dotted_border/dotted_border.dart';
import 'package:flutter/material.dart';

class CreateCustomExamTeacher extends StatelessWidget {
  const CreateCustomExamTeacher({Key? key}) : super(key: key);
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    MainButtonRed(
                      buttonName: AppStrings.kAddQCreateCustomExam,
                      onPressed: () {},
                    ),
                    SizedBox(
                      height: AppDimensions.getDimensions(requiredHeight: 33),
