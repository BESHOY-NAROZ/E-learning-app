...
class ExamClassRoomBottomSheet extends StatefulWidget {
  ...
  @override
  State<ExamClassRoomBottomSheet> createState() => _ExamClassRoomBottomSheetState();
}

class _ExamClassRoomBottomSheetState extends State<ExamClassRoomBottomSheet> {
  @override
      ...
      builder: (BuildContext context, void Function(void Function()) setState) {
        return InkWell(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Radio(
                                        ...
                                        groupValue: ExamClassRoomBottomSheet.currentRadio,
                                        ...
                                        onChanged: (value) {
                                          setState(() {
                                            ExamClassRoomBottomSheet.currentRadio =
                                                value.toString();
          ...
          child: CustomTextFormFiled(
            hintText: ExamClassRoomBottomSheet.currentRadio,
            textDirection: TextDirection.rtl,
