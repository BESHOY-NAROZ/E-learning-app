...
class BankCreateQuestionBottomSheet extends StatefulWidget {
  static String currentRadio = AppStrings.kChooseQCreateExam;
  ...
  @override
  State<BankCreateQuestionBottomSheet> createState() => _BankCreateQuestionBottomSheetState();
}

class _BankCreateQuestionBottomSheetState extends State<BankCreateQuestionBottomSheet> {
  @override
      ...
      builder: (BuildContext context, void Function(void Function()) setState) {
        return InkWell(
              ...
              showModalBottomSheet(
                ...
                builder: (context) {
                  return Container(
                    ...
                    height: AppDimensions.getDimensions(requiredHeight: 372),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      MainTextGrey(
                                        myText: AppLists.kQuestionTypeList[index],
                                        fontSize: 12,
                                      ...
                                      SizedBox(
                                        ...
                                        child: Radio(
                                          value: AppLists.kQuestionTypeList[index],
                                          groupValue: BankCreateQuestionBottomSheet.currentRadio,
                                          ...
                                          onChanged: (value) {
                                            setState(() {
                                              BankCreateQuestionBottomSheet.currentRadio =
                                                  value.toString();
                              ...
                              itemCount: AppLists.kQuestionTypeList.length),
                          const Spacer(),
                        ],
                      ),
                    ),
            ...
            child: CustomTextFormFiled(
              hintText: BankCreateQuestionBottomSheet.currentRadio,
              textDirection: TextDirection.rtl,
