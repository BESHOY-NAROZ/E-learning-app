...
class SentExamDoneToGroupsTeacher extends StatelessWidget {
  const SentExamDoneToGroupsTeacher({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              MainButtonRed(
                buttonName: AppStrings.kBackToGroupsExamEditing,
                onPressed: () {
