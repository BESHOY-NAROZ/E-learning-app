...
class BloomQuestionBottomSheet extends StatefulWidget {
  static String currentRadio = AppStrings.kUnderStandClassificationCreateExam;
  ...
  @override
  State<BloomQuestionBottomSheet> createState() => _BloomQuestionBottomSheetState();
}

class _BloomQuestionBottomSheetState extends State<BloomQuestionBottomSheet> {
  @override
      ...
      builder: (BuildContext context, void Function(void Function()) setState) {
        return InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    MainTextGrey(
                                      myText: AppLists.kBloomList[index],
                                      fontSize: 12,
                                    ...
                                    SizedBox(
                                      ...
                                      child: Radio(
                                        value: AppLists.kBloomList[index],
                                        groupValue: BloomQuestionBottomSheet.currentRadio,
                                        ...
                                        onChanged: (value) {
                                          setState(() {
                                            BloomQuestionBottomSheet.currentRadio =
                                                value.toString();
                            ...
                            itemCount: AppLists.kBloomList.length),
                        const Spacer(),
                      ],
                    ),
                  ),
          ...
          child: CustomTextFormFiled(
            hintText: BloomQuestionBottomSheet.currentRadio,
            textDirection: TextDirection.rtl,
