  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
        bottom: AppDimensions.getDimensions(requiredHeight: 19)
      ),
        ...
        child: Row(
          ...
          children: [
             Column(
               mainAxisAlignment: MainAxisAlignment.end,
              children: [
                const Text(AppStrings.kContainerTeachersGroupsStudentGroups,
                ...
                8),),
                const Text(AppStrings.kContainerFirstTeacherGroupsStudentGroups,
                  textAlign: TextAlign.end,
                  style: TextStyle(
                      fontFamily: 'Almarai',
                      color: AppColors.kBottomBottomListHintMainScreenHome,
                ...
                SizedBox(height: AppDimensions.getDimensions(requiredHeight:
                8),),
                const Text(AppStrings.kContainerSecondTeacherGroupsStudentGroups,
                  textAlign: TextAlign.end,
                  style: TextStyle(
                      fontFamily: 'Almarai',
                      color: AppColors.kBottomBottomListHintMainScreenHome,
