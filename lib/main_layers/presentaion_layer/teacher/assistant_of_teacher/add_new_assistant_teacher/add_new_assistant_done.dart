...
class AddNewAssistantDoneTeacher extends StatelessWidget {
  const AddNewAssistantDoneTeacher({Key? key}) : super(key: key);
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              AppStrings.kAddingDoneAssistantOfTeacher,
            ...
            MainButtonRed(
              buttonName: AppStrings.kBackToAssistantsOfTeacher,
              onPressed: () {
            ...
            MainButtonGrey(
              ...
              onPressed: () {
                Navigator.pushNamed(context, RoutesManager.removeOrderAssistantJoiningDoneTeacher);
              },
            )
          ],
        ),
