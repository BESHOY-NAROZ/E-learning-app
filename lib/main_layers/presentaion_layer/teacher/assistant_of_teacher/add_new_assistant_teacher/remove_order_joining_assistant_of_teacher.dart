...
class RemoveOrderAssistantJoiningDoneTeacher extends StatelessWidget {
  const RemoveOrderAssistantJoiningDoneTeacher({Key? key}) : super(key: key);
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              AppStrings.kRemoveAssistantOfTeacher,
