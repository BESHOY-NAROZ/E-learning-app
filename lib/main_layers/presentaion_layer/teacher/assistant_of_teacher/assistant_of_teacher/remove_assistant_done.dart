...
class RemoveAssistantOfTeacherDone extends StatelessWidget {
  const RemoveAssistantOfTeacherDone({Key? key}) : super(key: key);
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            MainButtonRed(
              buttonName: AppStrings.kBackToAssistantOfTeacher,
              onPressed: () {
