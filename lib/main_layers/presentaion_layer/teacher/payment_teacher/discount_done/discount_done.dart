...
class DiscountDoneTeacher extends StatelessWidget {
  const DiscountDoneTeacher({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              MainButtonRed(
                buttonName: AppStrings.kDiscountDoneButtonPayment,
                onPressed: () {
                  Navigator.pushNamed(context, RoutesManager.paymentAfterDiscountTeacher);
                },
              ),
            ],
          ),
