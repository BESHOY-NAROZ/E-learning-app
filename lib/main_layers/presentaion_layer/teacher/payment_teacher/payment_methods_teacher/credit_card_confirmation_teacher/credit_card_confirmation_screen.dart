...
import 'credit_card_confirmation_countdown_timer.dart';

class CreditCardConfirmationTeacher extends StatefulWidget {
  const CreditCardConfirmationTeacher({
    Key? key,
  }) : super(key: key);
  ...
  @override
  State<CreditCardConfirmationTeacher> createState() => _CreditCardConfirmationTeacherState();
}

class _CreditCardConfirmationTeacherState extends State<CreditCardConfirmationTeacher> {
  @override
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            const MainAppBar(
              myTitle: AppStrings.kCreditConfirmationPayment,
              designHeight: 1006,
              designWidth: 360,
            ),
            SizedBox(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const MainTextBlue(
                    myText: AppStrings.kPaymentConfirmationPayment,
                  ),
                  SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                      if (CreditCardConfirmationTeacher.startCuntDown)
                        const CreditCardConfirmationCountDownTimer(),
                      InkWell(
                        onTap: () {
                          setState(() {
                            const CreditCardConfirmationCountDownTimer();
                            CreditCardConfirmationTeacher.startCuntDown = true;
                          });
                        },
                        child: MainHintTextRegistration(
                          myText: CreditCardConfirmationTeacher.startCuntDown
                              ? (AppStrings.kForgetPasswordGetCodePhoneCounter)
                              : AppStrings.kForgetPasswordGetCodeHintText,
                          color: CreditCardConfirmationTeacher.startCuntDown
