...
class PaymentDoneTeacher extends StatelessWidget {
  const PaymentDoneTeacher({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const MainTextBlue(
                myText: AppStrings.kPaymentPayment,
              ),
              ...
              SizedBox(height: AppDimensions.getDimensions(requiredHeight: 220)),
              MainButtonRed(
