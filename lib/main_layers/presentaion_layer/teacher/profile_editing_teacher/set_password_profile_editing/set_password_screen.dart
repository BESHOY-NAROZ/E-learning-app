...
class SetPasswordProfileEditingTeacher extends StatelessWidget {
  const SetPasswordProfileEditingTeacher({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SetPasswordValidationTeacher(),
                  SizedBox(
                  ...
                  MainButtonRed(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, RoutesManager.setPasswordDoneTeacher);
                    },
                  ),
                ],
              ),
