...
class AddOpinionDoneTeacher extends StatelessWidget {
  const AddOpinionDoneTeacher({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            MainButtonRed(
              ...
              onPressed: () {
                Navigator.pushNamed(context, RoutesManager.homeMainScreenTeacher);
              },
            ),
          ],
        ),
