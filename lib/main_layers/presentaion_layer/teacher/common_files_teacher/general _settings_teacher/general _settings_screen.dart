...
class GeneralSettingsTeacher extends StatefulWidget {
  const GeneralSettingsTeacher({Key? key}) : super(key: key);

  static int myIndex = 0;

  @override
  State<GeneralSettingsTeacher> createState() => _GeneralSettingsTeacherState();
}

class _GeneralSettingsTeacherState extends State<GeneralSettingsTeacher> {
  @override
