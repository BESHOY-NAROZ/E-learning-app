...
class AddNewStudentDoneTeacher extends StatelessWidget {
  const AddNewStudentDoneTeacher({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            MainButtonGrey(
              ...
              onPressed: () {
                Navigator.pushNamed(context, RoutesManager.removeOrderJoiningDoneTeacher);
              },
            )
          ],
        ),
