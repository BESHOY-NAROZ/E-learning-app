...
class RemoveSpecificAttachmentBottomSheetTeacher extends StatelessWidget {
        ...
        showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              ...
              height: AppDimensions.getDimensions(requiredHeight: 173),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    MainTextBlack(
                      myText: AppStrings.kDeleteAttachmentSheet,
                    ...
                    MainTextGrey(
                      myText: AppStrings.kDeleteAttachmentHintSheet,
                        ...
                        child: MaterialButton(
                            ...
                            onPressed: () {
                              Navigator.pushReplacementNamed(
                                  context, RoutesManager.removeSpecificAttachmentDoneTeacher);
                            },
                            child: Text(
