...
class SendAttachmentsDoneTeacher extends StatelessWidget {
  const SendAttachmentsDoneTeacher({Key? key}) : super(key: key);
      ...
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const MainTextBlue(
              myText: AppStrings.sendDoneAttached,
            ),
            SizedBox(height: AppDimensions.getDimensions(requiredHeight: 18)),
            Text(
              AppStrings.sendDoneHintAttached,
            ...
            MainButtonRed(
              buttonName: AppStrings.sendDoneButtonAttached,
              onPressed: () {
