...
class AddNewAttachedTeacher extends StatelessWidget {
  const AddNewAttachedTeacher({Key? key}) : super(key: key);
              ...
              child: SingleChildScrollView(
                child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  ...
                  MainButtonGrey(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, RoutesManager.addAttachedSpecificSubjectTeacher);
                    },
                  )
                ]),
              ),
