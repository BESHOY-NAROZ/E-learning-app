...
class UploadAttachedDoneTeacher extends StatelessWidget {
  const UploadAttachedDoneTeacher({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const MainTextBlue(
                myText: AppStrings.kUploadDoneNewAttached,
              ),
              SizedBox(height: AppDimensions.getDimensions(requiredHeight: 18)),
              Text(
                AppStrings.kUploadDoneHintNewAttached,
              ...
              MainButtonRed(
                buttonName: AppStrings.kUploadDoneButtonNewAttached,
                onPressed: () {
