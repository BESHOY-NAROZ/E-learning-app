...
class UpdateExplanation extends StatelessWidget {
  const UpdateExplanation({Key? key}) : super(key: key);
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    MainButtonRed(
                      buttonName: AppStrings.kUpdateAttached,
                      onPressed: () {
                        MyToast.showMyToast(
                          myMessage: AppStrings.kUpdateDoneAttached,
                          context: context,
