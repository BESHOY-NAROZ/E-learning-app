...
class SentCreatedDoneTeacher extends StatelessWidget {
  const SentCreatedDoneTeacher({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const MainTextBlue(
                myText: AppStrings.kSentExamDoneQuestion,
              ),
              SizedBox(height: AppDimensions.getDimensions(requiredHeight: 18)),
              Text(
                AppStrings.kSentExamDoneHintQuestion,
              ...
              MainButtonRed(
                buttonName: AppStrings.kSentExamDoneButtonQuestion,
                onPressed: () {
