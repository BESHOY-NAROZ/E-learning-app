...
class AddQuestionSpecificSubjectTeacher extends StatelessWidget {
  const AddQuestionSpecificSubjectTeacher({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: MainButtonRed(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, RoutesManager.questionTypeTeacher);
                        },
                      ),
                    ),
                    SizedBox(
