...
class SentTheQuestionDoneToMeTeacher extends StatelessWidget {
  const SentTheQuestionDoneToMeTeacher({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const MainTextBlue(
                myText: AppStrings.kMainSentDoneToMeQuestion,
              ),
              SizedBox(height: AppDimensions.getDimensions(requiredHeight: 18)),
              Text(
                AppStrings.kHintSentDoneToMeQuestion,
              ...
              MainButtonRed(
                buttonName: AppStrings.kButtonSentDoneToMeQuestion,
                onPressed: () {
